...
module Github.Enum.ProjectV2FieldType exposing (..)
...
decoder : Decoder ProjectV2FieldType
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid ProjectV2FieldType type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : ProjectV2FieldType -> String
toString enum____ =
    case enum____ of
        Assignees ->
            "ASSIGNEES"
...
-}
fromString : String -> Maybe ProjectV2FieldType
