...
-}
changedFilesIfAvailable : SelectionSet (Maybe Int) Github.Object.Commit
...
type alias CheckSuitesOptionalArguments =
    ...
    , first : OptionalArgument Int
    , last : OptionalArgument Int
    , filterBy : OptionalArgument Github.InputObject.CheckSuiteFilter
    }
...
checkSuites :
    ...
    -> SelectionSet decodesTo Github.Object.CheckSuiteConnection
    -> SelectionSet (Maybe decodesTo) Github.Object.Commit
checkSuites fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int, Argument.optional "filterBy" filledInOptionals____.filterBy Github.InputObject.encodeCheckSuiteFilter ]
                |> List.filterMap Basics.identity
    in
...
history fillInOptionals____ object____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "after" filledInOptionals____.after Encode.string, Argument.optional "before" filledInOptionals____.before Encode.string, Argument.optional "first" filledInOptionals____.first Encode.int, Argument.optional "last" filledInOptionals____.last Encode.int, Argument.optional "path" filledInOptionals____.path Encode.string, Argument.optional "author" filledInOptionals____.author Github.InputObject.encodeCommitAuthor, Argument.optional "since" filledInOptionals____.since (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecGitTimestamp), Argument.optional "until" filledInOptionals____.until (Github.ScalarCodecs.codecs |> Github.Scalar.unwrapEncoder .codecGitTimestamp) ]
                |> List.filterMap Basics.identity
    in
