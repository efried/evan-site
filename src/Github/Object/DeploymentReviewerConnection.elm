...
module Github.Object.DeploymentReviewerConnection exposing (..)
...
-}
edges :
    SelectionSet decodesTo Github.Object.DeploymentReviewerEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Github.Object.DeploymentReviewerConnection
edges object____ =
...
-}
nodes :
    SelectionSet decodesTo Github.Union.DeploymentReviewer
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Github.Object.DeploymentReviewerConnection
nodes object____ =
...
-}
totalCount : SelectionSet Int Github.Object.DeploymentReviewerConnection
totalCount =
