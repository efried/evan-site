...
codecs : Github.Scalar.Codecs Base64String Date DateTime GitObjectID GitSSHRemote GitTimestamp Html Id PreciseDateTime Uri X509Certificate
codecs =
    Github.Scalar.defineCodecs
        { codecBase64String = defaultCodecs.codecBase64String
